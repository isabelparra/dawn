...
document.addEventListener("DOMContentLoaded", function() {
  if (window.location.pathname.includes("about")) {
    document.querySelector("body").classList.add("gb-pgs-about");
    document.querySelector(".banner__media img").setAttribute('id', 'gb-about-img');
    document.querySelector('.marquee-text').setAttribute('id', 'marquee-about');
  } else if (window.location.pathname.includes("blog")) {

  } else if (window.location.pathname.includes("contact")) {
    document.querySelector("body").classList.add("gb-pgs-contact");
  }
});
  ...
  // $(document).ready(function () { 
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var mobileScreen = window.matchMedia('max-width: 780px');
      if (menuDrawer && header && mobileScreen) {
...
const allIconRows = document.querySelectorAll('.row.icon-row');
console.log(allIconRows);

const targetText = document.querySelector('.icon-row:nth-child(6)');
